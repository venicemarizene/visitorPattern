public class TelcoPromo {
    public static void main(String[] args) {
        TelcoSubscription smart = new Telco(15, 500, TelcoName.Smart, false);
        TelcoSubscription globe = new Telco(10, 450, TelcoName.Globe, true);
        TelcoSubscription ditto = new Telco(8, 400, TelcoName.Ditto, true);
